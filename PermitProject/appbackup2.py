...
def make_property(i: int):
    ...
    return {
        ...
        "contact_info": [
            {"email": fake.unique.email(), "phone": fake.numerify("###-###-####")}
      ...
      <div class="py-2">
        ...
        <form method="post">
            ...
            <button type="button" class="btn btn-info mb-3"
                onclick="document.getElementById('contacts').insertAdjacentHTML('beforeend', '<div class=\\'input-group mb-2\\'><input class=\\'form-control\\' name=\\'email\\' placeholder=\\'Email\\'><input class=\\'form-control\\' name=\\'phone\\' placeholder=\\'Phone\\'></div>')">
                Add Contact
                </button>
